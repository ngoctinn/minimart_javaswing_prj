...
public class nhapHangPanel extends JPanel {
    ...
    public void initGUI() {
        ...
        JRadioButton radioButtonshow2 = new JRadioButton("Đã Nhập Hàng");
        ...
        JList<String> list1 = new JList<>(new String[]{"Tây Bán Bom", "Tín Víp Pro", "Thư Bồ Tín", "An Má Bé Sol", "HURRYKHANG","Jack Bỏ Con"});
