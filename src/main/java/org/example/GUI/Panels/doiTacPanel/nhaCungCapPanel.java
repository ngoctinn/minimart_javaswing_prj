...
public class nhaCungCapPanel extends JPanel {
    ...
    public void initGUI() {
        ...
        JRadioButton radioButtonshow1 = new JRadioButton("Tất Cả");
        radioButtonshow1.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        JRadioButton radioButtonshow2 = new JRadioButton("Đang Hoạt Động");
        radioButtonshow2.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        JRadioButton radioButtonshow3 = new JRadioButton("Ngừng Hoạt Động");
